...
def chirp_generator(fs=100e6, pWidth=10e-6, pri=100e-6, chirpBw=20e6, cf=1e9, format='iq', zeroLast=False):
...
def barker_generator(fs=100e6, pWidth=10e-6, pri=100e-6, code='b2', cf=1e9, format='iq', zeroLast=False):
