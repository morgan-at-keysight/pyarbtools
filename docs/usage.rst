...
met by the waveform::
    ...
    # Example
    iq = pyarbtools.wfmBuilder.multitone(fs=100e6, spacing=1e6, num=11, wfmFormat='iq')
    vsg.download_wfm(iq)
...
them as generic signals for DSP work::
    ...
    modType = 'qam64'
    symRate = 20e6
    iq = pyarbtools.wfmBuilder.digmod_prbs_generator(fs=fs, modType=modType, symRate=symRate)
